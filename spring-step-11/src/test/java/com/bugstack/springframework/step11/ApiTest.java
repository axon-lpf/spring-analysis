...
import com.bugstack.springframework.aop.MethodMatcher;
...
import com.bugstack.springframework.aop.framework.JdkDynamicAopProxy;
...
public class ApiTest {
    ...
    public void test_aop() throws NoSuchFieldException, NoSuchMethodException {
        ...
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut("execution(* com.bugstack.springframework.step11.UserServiceImpl.*(..))");
    ...
    public void test_dynamic() throws NoSuchFieldException, IllegalAccessException {
        ...
        advisedSupport.setMethodMatcher(new AspectJExpressionPointcut("execution(* com.bugstack.springframework.step11.UserServiceImpl.*(..))"));
