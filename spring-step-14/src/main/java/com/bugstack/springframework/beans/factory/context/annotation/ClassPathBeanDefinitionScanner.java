...
import com.bugstack.springframework.beans.factory.annotation.AutowiredAnnotationBeanPostProcessor;
...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
    ...
    public void doScan(String... basePackages) {
        ...
        registry.registerBeanDefinition("com.bugstack.springframework.beans.factory.annotation", new BeanDefinition(AutowiredAnnotationBeanPostProcessor.class));
    }
