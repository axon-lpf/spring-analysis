package com.axon.springframework.beans.factory.context.annotation;

import cn.hutool.core.util.StrUtil;
import com.axon.springframework.beans.factory.annotation.AutowiredAnnotationBeanPostProcessor;
...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
    ...
    public void doScan(String... basePackages) {
        ...
        registry.registerBeanDefinition("com.axon.springframework.beans.factory.annotation", new BeanDefinition(AutowiredAnnotationBeanPostProcessor.class));
    }
